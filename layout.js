document.addEventListener("DOMContentLoaded", function(event) { 
    document.querySelector('body').innerHTML=`<div class="keyboard metal">
    <ul class="top"><li class="esc" data-key="esc">Esc</li>
    <li class="margin-l">F1</li>
    <li>F2</li>
    <li>F3</li>
    <li>F4</li>
    <li class="margin-l">F5</li>
    <li>F6</li>
    <li>F7</li>
    <li>F8</li>
    <li class="margin-l">F9</li>
    <li>F10</li>
    <li>F11</li>
    <li>F12</li>
    <li class="margin-l pad-sm" data-key="print">PrtSc</li>
    <li class="pad-sm" data-key="scrolllock">ScrLk</li>
    <li class="pad-sm" data-key="pause">Pause</li>
    <li class="margin-l half" data-key="calculator"> <i class="fa fa-calculator"></i></li>
...
<ul>
    ...
    <li class="margin-l pad-sm" data-key="insert">Ins</li>
    <li class="pad-sm" data-key="home">Home</li>
    <li class="pad-sm" data-key="pageup">PgUp</li>
    <li class="margin-l half pad-sm" data-key="numlock">Num</li>
    <li>/</li>
    <li>*</li>
...
<ul>
    ...
    <li class="margin-l pad-sm vol-off" data-key="backspace" data-function="mute">Del<i class="fa fa-volume-off"></i></li>
